...
<div class="historia" id="origem">
    ...
    <div class="texto-historia">
        ...
        <section>
            ...
            <img src="img/dfsp_logo.png" alt="">
        </section>
        <hr>
        <p>
            Em 1960, ocorreu a fusão do DFSP com a Guarda Especial de Brasília (GEB), responsável por manter a ordem durante a construção da nova capital, mantendo-se a denominação DFSP.
        </p>
        <p>
            Buscando modernizar sua estrutura, o DFSP passou a se inspirar em modelos policiais de países desenvolvidos, como Estados Unidos, Canadá e Inglaterra. No final de 1960, o Poder Executivo encaminhou ao Congresso um anteprojeto de lei para a criação de um organismo policial de âmbito nacional. A proposta foi concretizada com a aprovação da Lei nº 4.483, de 16 de novembro do mesmo ano, reorganizando o DFSP e ampliando sua atuação federal.
        </p>
        <p>
            Por fim, a Constituição de 1967, em seu artigo 210, alterou a denominação do órgão para Departamento de Polícia Federal, definindo suas funções no artigo 8º, inciso VII, alíneas "a" a "d". A mudança foi efetivada em fevereiro do mesmo ano.
        </p>
    </div>
    <div class="atuacao-historia">
        <section>
            <h5>Polícia Federal atualmente</h5>
            <p>
                Hoje, a Polícia Federal é responsável por diversas funções, como:
                <ul>
                    <li>
                        Investigar crimes contra a União (corrupção, tráfico internacional, crimes ambientais).
                    </li>
                    <li>
                        Controlar fronteiras e aeroportos.
                    </li>
                    <li>
                        Combater crimes cibernéticos e financeiros.
                    </li>
                    <li>
                        Emitir passaportes e fiscalizar imigração.  
                    </li>
                    <li>
                        Atuar em operações internacionais e cooperação com Interpol.
                    </li>
                    <li>
                        A Polícia Federal continua a evoluir e desempenha um papel fundamental na segurança e justiça do Brasil.
                    </li>
                </ul>
            </p>
        </section>
